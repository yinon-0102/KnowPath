...
from knowpath_backend.memory import MemoryConfig, MemoryManager
...
class Agent(ABC):
    ...
    def _install_memory_tools(self, tool_registry) -> None:
        ...
        from knowpath_backend.tools.builtin.recall import RecallTool
        from knowpath_backend.tools.builtin.remember import RememberTool
