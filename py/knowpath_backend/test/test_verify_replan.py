...
from knowpath_backend.verify.convergence import ConvergenceJudge
...
def _make_agent(monkeypatch, responses, *, spec, tools=None, replan_budget=1):
    ...
    from knowpath_backend.memory import MemoryManager, MemoryConfig
    ...
    from knowpath_backend.verify import CheckerRunner
...
def test_make_plan_method_delegates(monkeypatch):
    ...
    import knowpath_backend.agents.function_call_agent as fca
