...
运行：
    uv run python -m unittest knowpath_backend.test.test_simple_agent -v
"""
import unittest

from knowpath_backend.agents.simple_agent import MySimpleAgent
from knowpath_backend.tools import CalculatorTool, ToolRegistry
