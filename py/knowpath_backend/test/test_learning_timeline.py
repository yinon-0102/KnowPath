...
from knowpath_backend.test.test_learning_state_persistence import workspace, create
...
def test_grade_review_never_rewrites_original_timeline_event(workspace):
    from knowpath_backend.test.test_learning_grade_reviews import completed
    factory, space_id, _, _ = workspace
