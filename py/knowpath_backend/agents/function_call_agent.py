...
from knowpath_backend.core.agent import Agent
from knowpath_backend.core.config import Config
from knowpath_backend.core.llm import MyLLM
from knowpath_backend.core.message import Message
from knowpath_backend.tools.registry import ToolRegistry
from knowpath_backend.verify.replan import make_plan
from knowpath_backend.planning.todo import todo_system_message, TODO_HEADING
...
class MyFunctionCallAgent(Agent):
    ...
    def __init__(self,
        ...
        if enable_verify:
            from knowpath_backend.verify import (
    ...
    def _verify_gate(self, candidate, messages, spec, round_idx, history, best,
        ...
        """
        from knowpath_backend.verify import CheckContext, residual, fingerprint, Verdict
        from knowpath_backend.verify.residual import effective_count
        from knowpath_backend.verify.loop import feedback_from
        from knowpath_backend.verify.convergence import Round
    ...
    def _tdd_should_run(self, input_text: str) -> bool:
        from knowpath_backend.tdd import classify
    ...
    def _run_tdd(self, input_text: str) -> str:
        ...
        # 透传回调留作后续(与流式渲染一并做)。
        from knowpath_backend.tdd import run_tdd
        self._in_tdd = True
    ...
    def _veto_premature_completions(self, plans: List[Dict[str, Any]]) -> None:
        ...
        if not has_work:
            return
        from knowpath_backend.planning.todo import parse_todo_lines
