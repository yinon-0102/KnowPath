...
from my_agent_llms.learning.model_tasks import ModelTaskWorker, timestamp
from my_agent_llms.test.test_learning_material_deletion import workspace, seed
from my_agent_llms.test.test_learning_model_tasks import enqueue
...
def test_heartbeat_keeps_slow_generation_owned_beyond_original_lease(workspace, kind, monkeypatch):
    from my_agent_llms.learning.model_tasks import ModelLease
    state = workspace()
