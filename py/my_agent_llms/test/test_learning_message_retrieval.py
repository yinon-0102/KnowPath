...
from my_agent_llms.test.test_learning_state_persistence import workspace
from my_agent_llms.test.test_learning_messages import service
...
def test_message_real_vector_retrieval_uses_pinned_candidates(workspace):
    ...
    from my_agent_llms.test.test_learning_vector_retrieval import Embedder
    factory, space_id, _, _ = workspace
    state, generator = service(factory)
...
def test_api_closes_its_owned_retriever_on_shutdown(monkeypatch):
    import my_agent_llms.learning.api as module
